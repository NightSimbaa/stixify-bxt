...
let API = {
  ...
  createReport: function (fileType, fileData, fileName, reportTitle, reportDescription, collectionUuid, reportTlpLevel, reportConfidence, reportTags, reportPlaintext) {
    console.log(fileType, fileData, fileName, reportTitle, reportDescription, collectionUuid, reportTlpLevel, reportConfidence, reportTags, reportPlaintext);
    var deferred = Q.defer();
    var myHeaders = new Headers();
    myHeaders.append("Accept", "application/json");
    ...
    fetch(C.API_URL + collectionUuid + "/reports/", requestOptions)
      .then(response => {
